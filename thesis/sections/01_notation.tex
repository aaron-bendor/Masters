...
$\gobs(x, x')$ & \emph{Hitting rate} from $x$ to $x'$, a discounted first-passage probability on $\Xo \times \Xo$; empirical in SUMO/Xuancheng and analytically generated only in the Tier~1 synthetic benchmark. \\
